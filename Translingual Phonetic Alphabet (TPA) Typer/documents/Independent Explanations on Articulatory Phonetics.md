...
[﻿](§0.2)In this science document, I try to explain everything I learned and discovered regarding this subject matter. I use a logical method that doesn't invalidate itself. Some of the content here are my unique findings and reports. They may not necessarily be found in other literature and may be in contrast with the explanations given by other sources.

[﻿](§0.3)I must say that the literature on the subject of articulatory phonetics is quite extensive. On websites such as Wikipedia.org, a lot of information can be found. I have learned a lot from Wikipedia.org myself. However, certain things with regard to this scientific subject are missing in literature or they are wrong. And, if it isn't necessarily wrong, it fails to be precise. This became more apparent to me as I continued my studies in phonetics. After I progressed in my studies, I started to see mistakes with the International Phonetic Alphabet. I decided to develop a Unicode phonetic alphabet of my own. I named that project “ ﻿Translingual Phonetic Alphabet﻿ ”. I wrote the document “ ﻿Independent Explanations on Articulatory Phonetics: A Criticism of the International Phonetic Alphabet﻿ ”.

[﻿](§0.4)As the title of this work makes it apparent, it is supposed to be an independent science document that sheds light on a scientific subject. I don't necessarily have to accept the arguments and explanations given by other sources. Instead, I have done my own research. I aim for this document to be the authoritative scientific work on the subject of articulatory phonetics. It aims to document everything extensively with regard to the subject. It uses extensive English vocabulary to make explanations, and some of my own words to achieve this goal. In keeping with the scientific tradition, the words are derived mainly from Greek and Latin words. I felt the need to create and use new descriptive words to make accurate and full explanations. However, I define these words to try to eliminate confusion. I consider this work to be my greatest scientific literary work, and it is also my longest work. I aim to translate this work into different languages if I have the time to do so. I do have the tools and the capacity to make my own translations.
...
[﻿](§0.8)In comparison to my twenty vowels, the International Phonetic Alphabet has over thirty vowels. The website Wikipedia.org lists it as having thirty‑three vowels. I believe that is too many vowels. Many of these vowels are measurably wrong, not factual, and superfluous. I also believe that the vowel chart of the IPA is quite wrong. I give good criticism of the vowel system of the IPA in this work. I had to put a lot of effort in trying to create a new, factual vowel chart. I believe did so successfully. The consonants of the IPA are quite good and factual. However, it has a fewer consonant count than the TPA. This stems from the fact that the IPA doesn't count nor take into account all of the possible consonant sounds that can be articulated in the vocal tract. I tried to identify every single sound that can be pronounced. I also believe I created a very factual, universal phonetic system that works with all languages. I believe minute differences in individual pronunciations and accents have no place in a universal phonetic notation system for languages. I believe that these largely have to do with the topics of auditory perceptions, psychology and mimicry and falls outside the scope of articulatory phonetics. I try to prove that claim in this work.

#### CHAPTER ONE ( ﻿Ⅰ﻿ ): Anatomy and Introduction; The Definitions of the Places of Articulations ( ﻿POA﻿ )

[﻿](§1.1)In order to understand articulatory phonetics, we need to understand and study human anatomy to some extent. The parts of the body that we are concerned with are located in the head and the throat ( ﻿Lat. *ɢᴜᴛᴛᴜʀ*﻿ ). Collectively, we call the parts of the body where speech is realised “ ﻿the vocal tract﻿ ” ( ﻿Lat. *ᴛʀᴀᴄᴛᴜꜱ ᴠᴏᴄᴀʟɪꜱ*﻿ ).

[﻿](§1.2)The vocal tract starts at the glottis. The glottis is an organ located within the throat. It is a V‑shaped opening that we have control over, and it plays a very important role in speech. The entirety of the areas located above the glottis constitute the vocal tract. These include the epiglottis, the tongue ( ﻿Lat. *ʟɪɴɢᴜᴀ*﻿ ), the uvula, the hard palate ( ﻿Lat. *ᴘᴀʟᴀᴛᴜᴍ*﻿ ), the soft palate ( ﻿Lat. *ᴠᴇʟᴜᴍ*﻿ ), the alveolar ridge, also known as the alveolar process ( ﻿Lat. *ᴘʀᴏᴄᴇꜱꜱᴜꜱ ᴀʟᴠᴇᴏʟᴀʀɪꜱ*﻿ ), the teeth ( ﻿Lat. *ᴅᴇɴᴛᴇꜱ*﻿ ), the oral tract ( ﻿Lat. *ᴛʀᴀᴄᴛᴜꜱ ᴏʀᴀʟɪꜱ*﻿ ), the lips ( ﻿Lat. *ʟᴀʙɪᴀ*﻿ ), and the nasal tract ( ﻿Lat. *ᴛʀᴀᴄᴛᴜꜱ ɴᴀꜱᴀʟɪꜱ*﻿ ). It is a mistake to exclude the nasal cavity from the vocal tract. The nasal cavity is, in fact, a part of the vocal tract. Even if the external nose is not a part of it, the nasal cavity is connected to the oral cavity at the back of the mouth at the soft palate, not at the uvula. The uvula looks like a small tongue that hangs down from the soft palate. The first place of articulation is the glottis, and the last, the most upper place of articulation is the nasal cavity. There are about twenty places of articulation. The epiglottis is the flap that is located above the glottal opening, and it has an important role in swallowing. It acts like a slide during the function of swallowing, it closes the glottal opening, and prevents choking. The esophageal opening is located just under the glottis ( ﻿behind the glottis﻿ ). It can be difficult to see in photographs because it is normally closed and hidden. During swallowing, the epiglottis covers the glottis to prevent choking, and the chewed food ( ﻿Lat. *ʙᴏʟᴜꜱ*﻿ ) slides into the esophagus.
...
[﻿](§1.4)The palate has to be correctly separated into two parts: the hard palate ( ﻿Lat. *ᴘᴀʟᴀᴛᴜᴍ*﻿ ) and the soft palate ( ﻿Lat. *ᴠᴇʟᴜᴍ*﻿ ). This is because, for the anterior part of the palate, there is a bony structure right above it, while that isn't the case for the posterior soft palate, which arcs downwards and is mobile. It can be moved up and down and is done so during speech. The soft palate plays an important role in the pronunciation of certain consonants and sounds.

[﻿](§1.5)The lungs, the diaphragm, and the trachea also have secondary involvements. Although their primary function is breathing, they have to be put into the picture to explain “ ﻿pulmonic sounds﻿ ”. Furthermore, the jaw ( ﻿Lat. *ᴍᴀxɪʟʟᴀ*﻿ ) also plays a secondary role and needs to be put into the picture to define vowels accurately. I insist that the first place of articulation is the glottis, going upwards and gradually ending with the lips and the nasal cavity. It is a mistake to start ordering these sounds, starting from the lips and going down.
...
##### [﻿](§1.17)*( ﻿2﻿ ) The complete list of the places of articulation:*

[﻿](§1.18)GLOTTIS ***(GLOTTAL)***  
...
##### [﻿](§3.1)*( ﻿1﻿ ) Affricates ( ﻿stop‑strictives﻿ ):*
...
&nbsp;&nbsp;&nbsp;&nbsp;Alternative letter: { ɡ } (U+0261) “latin small letter script g”  
...
[﻿](§3.13)⁽¹⁾ This is the same sound as the cough that people make when they cough. Can not be voiced due to the closure of the glottis.
...
##### [﻿](§3.34)*( ﻿7﻿ ) Velarics ( ﻿lingual egressives﻿ ):*

[﻿](§3.35)Velarics are sounds that are pronounced by pushing the air out with the tongue. Only sounds pronounced past the body of the tongue can be pronounced this way, such as ‘ ﻿t﻿ ’, ‘ ﻿p﻿ ’, and ‘ ﻿f﻿ ’. They have no glottalic or pulmonic involvement. I could only identify three of them. Try pronouncing these sounds now.
...
[﻿](§3.46){ ʜ } voiceless epiglottal trill (U+029C) “latin letter small capital h”  
...
&nbsp;&nbsp;&nbsp;&nbsp;Alternative letter: { ꞵ } (U+A7B5) “latin small letter beta”  
&nbsp;&nbsp;&nbsp;&nbsp;Alternative letter: { β } (U+03B2) “greek small letter beta”

[﻿](§3.50)⁽¹⁾ I investigated this IPA letter [ ﻿ɦ﻿ ] and concluded that it is not a real thing. What makes [ ﻿h﻿ ] real is that it's an exhalation of air. If it is voiced, it would only be a vowel sound. It simply cannot be voiced.
...
[﻿](§3.67)For this reason, approximants can also be a part of diphthongs. I call them “ ﻿constricted diphthongs﻿ ” compared with “ ﻿diphthongs﻿ ”. In this case, they may either be at the start of the diphthong or the end.

[﻿](§3.68){ ᴙ } unrounded voiced uvular approximant (U+1D19) “latin letter small capital reversed r”  
...
[﻿](§3.72)***Extra Tense Vocoids (approximants or  ﻿semi‑vowels﻿ ):*** They are so restricted that we classify them as consonants; they are one level more lax than fricatives and two levels more lax than plosives. They form the base level for all the other vowels and are measured from there correctly.

[﻿](§3.73)***Tense Vocoids ( ﻿IPA close vowels﻿ ):*** The jaw is either not lowered down or lowered slightly during the articulation of these vowels. This also limits the positioning of the tongue. Another word for tense vowel is close vowel, as it is used in the IPA.

[﻿](§3.74)***Near‑Tense Vocoids ( ﻿IPA near‑close vowels﻿ ):*** The jaw is lowered down slightly, a little more than tense vocoids. Another word for near-tense vowel is near-close vowel, as it is used in the IPA.

[﻿](§3.75)***Lax Vocoids ( ﻿IPA open-mid vowels﻿ ):*** The jaw is plentily lowered down during the pronunciation of these vocoids. The tongue has more space to roam; as a result, the tongue has more possible positions for placement. These are around what the IPA calls open-mid level vowels or near‑open vowels.

[﻿](§3.76)***Extra‑Lax Vocoids ( ﻿IPA open vowels﻿ ):*** The jaw is lowered down very much, perhaps about as much as it could be lowered comfortably. They are approximately at the location of the IPA open vowels.

| [﻿](§3.77)REAR | VOCOIDS | CENTER | VOCOIDS | FRONT | VOCOIDS |
| :-----------: | :-----: | :----: | :-----: | :---: | :-----: |
|       ɰ       |    w    |        |         |   y   |    ɥ    |
|       ᴕ       |    u    |        |         |   ɪ   |    ʉ    |
|       ə       |    ʊ    |        |         |   ᵻ   |    ᵿ    |
...
[﻿](§3.78){ ɰ } unrounded rear extra-tense vocoid (U+0270) “latin small letter turned m with long leg”  
...
[﻿](§3.79){ ᴕ } unrounded rear tense vocoid (U+1D15) “latin letter small capital ou”  
...
[﻿](§3.80){ ə } unrounded rear near-tense vocoid (U+0259) “latin small letter schwa”  
...
[﻿](§3.82){ ᴀ } unrounded rear extra-lax vocoid (U+1D00) “latin letter small capital a”  
...
[﻿](§3.84)So, what is the difference between [ ﻿i﻿ ] and [ ﻿e﻿ ], or [ ﻿u﻿ ] and [ ﻿o﻿ ]?
...
[﻿](§3.96)It is also important to understand that approximants can also act as vowels. For example, the French pronunciation of the vowel [ ﻿i﻿ ] can be correctly described as [ ﻿j﻿ ]. That is, the tongue is slightly higher when this vowel is pronounced than in English.

[﻿](§3.97)Please find the vowel chart of the International Phonetic Alphabet here for comparison:  
...
[﻿](§6.2)There are other secondary articulations, such as labialisation. That is, the lips are rounded during the articulation of a consonant. Nasalisation, that is, the velum is lowered to make the air pass through the nasal cavity as opposed to the oral cavity. Pharyngealisation, whereby a restriction is made in the throat, such as in Arabic. Velarisation or lingual retraction, whereby the tongue is retracted backwards during the pronunciation of a consonant. For example, in English, this is how the letter ‘ ﻿L﻿ ’ is pronounced. While it is being pronounced, the tongue is retracted backwards. This is a velarised ‘ ﻿L﻿ ’ and is also called a “ ﻿dark L﻿ ” in literature.

[﻿](§6.3)Thus, I call phones that have secondary articulations complex phones as opposed to simple or plain phones. This distinction must be made in phonetics because different parts of the vocal tract can be utilised at the same time. Sometimes, these pronunciations will make a different word; that is, a language may make a phonological distinction between simple phones and complex phones.
...
##### [﻿](§10.11)*( ﻿2﻿ ) The voiced glottal fricative is not a thing:*

[﻿](§10.12)https://en.wikipedia.org/wiki/Voiced_glottal_fricative  
The voiced glottal fricative [ ﻿ɦ﻿ ] does not exist. Its voiceless variant [ ﻿h﻿ ] does exist because it is simply an exhalation of breath. But if it were to be voiced, then it would be a vowel instead. I searched and I could not find evidence for the existence of this particular sound in any alphabet or language.

##### [﻿](§10.13)*( ﻿3﻿ ) The voiced alveolar approximant is a voiced alveolar fricative:*
...
[﻿](§10.18)The click that people make when scoffing is indeed dental. However, the click that people make when they urge a horse to move is velar. I believe they are simply calling the velar click a lateral click in this article because they believe that it is pronounced on one side of the mouth. That itself may be true, but I believe it is more accurately described as a velar click, as that is the place of articulation where it is pronounced.
...
[﻿](§10.22)They are right about the second part. Ejective consonants are pronounced with a glottalic egressive airstream. However, I disagree with the first part where it says “ ﻿usually﻿ ”. I am convinced that ejective consonants are always voiceless and that it is impossible to pronounce voiced ejective consonants.

##### [﻿](§10.23)*( ﻿6﻿ ) The velar and the uvular lateral consonants are not possible:*

[﻿](§10.24)https://en.wikipedia.org/wiki/Lateral_consonant#List_of_laterals

> [﻿](§10.25)Voiced dental lateral approximant [l̪] (in Arabic, Chinese, Tamil)
> Voiced alveolar lateral approximant [l] (in Dutch, English, Spanish)
> Voiced retroflex lateral approximant [ɭ] (in Dhivehi, Korean, Telegu)
...
> [﻿](§10.28)Voiced interdental approximant [l̪͆]
> Voiced dental lateral approximant [l̪]
...
> ~~Voiced uvular lateral approximant [ʟ̠]~~

##### [﻿](§10.29)*( ﻿7﻿ ) The glottal stop and the glottal plosive are two different things:*

[﻿](§10.30)The glottal stop as it is defined by the IPA, is correct. However, it does not discuss the “ ﻿glottal plosive﻿ ”. This is because it is not a speech sound but instead, the glottal plosive is the coughing sound. Since the word “ ﻿stop﻿ ” is being used synonymously with the word “ ﻿plosive﻿ ” in the context of the IPA, an important distinction has to be made here. I also call the glottal stop a “ ﻿glottal percussive﻿ ” in this document.

##### [﻿](§10.31)*( ﻿8﻿ ) The criticism of the words “ ﻿palatalisation﻿ ”, “ ﻿velarisation﻿ ” and “ ﻿uvularisation﻿ ”:*

[﻿](§10.32)In literature, you will see the word “ ﻿palatalisation﻿ ”. It is, in fact, lingual retraction towards the palate. The same is true for “ ﻿velarisation﻿ ”, lingual retraction towards the velum, and “ ﻿uvularisation﻿ ”, lingual retraction towards the uvula. These motions, in fact, do not involve any kind of active movement with the palate, the velum, or the uvula. It only has to do with the tongue. There is also the word “ ﻿nasalisation﻿ ” which has to do with the velum, the back part of the palate (soft palate). In nasalisation, the velum is lowered, allowing the air to exit from the nasal cavity. In “ ﻿oralisation﻿ ”, the velum moves up and blocks the nasal cavity, so the air and the sound exit out of the oral cavity. The particular scenarios concerning nasalisation and oralisation do not involve the tongue but is a velar intervention.
...
#### CHAPTER TWELVE ( ﻿Ⅻ﻿ ): Explanation of Lisping and Other Faulty Speech
...
#### CHAPTER FIFTEEN ( ﻿ⅩⅥ﻿ ): TPA Design Goals

- [﻿](§15.1)**Caseless alphabet:** The TPA does not have a case distinction, just like many other alphabets. It is in fact a small‑case Latin alphabet and intentionally excludes all capital‑case letters in favour of small‑case letters. Although some of its letters are bigger in size and have the glyphs of capital letters.

- [﻿](§15.2)**Phonetic accuracy:** I tried to measure out the vocal tract and place all the sounds and the letters in relation to each other. I tried to make the alphabet millimetrically accurate with regard to the structure of the vocal tract and the tongue. I am amazed at how accurate the alphabet turned out to be.

- [﻿](§15.3)**Complementing the IPA:** I know that the IPA will possibly be forever more popular than the TPA. No matter if the TPA is better, it is not my aim to beat the IPA or to be more popular than the IPA. The TPA, however, tries to be a complete and superior alternative to the IPA and to complement the IPA in any circumstances where it is not favoured by authors.

- [﻿](§15.4)**Font compliance:** The TPA is not bound to a specific font, nor does it try to be. However, because the TPA uses so many different combining diacritics and letters, and because these combining diacritics can then be used on a letter that already has combining diacritics, some letters will not display correctly on some fonts. The fact is, there cannot be a perfect font for the TPA, and no font is perfect. We don't have this problem if we are writing with a pen and paper, but on computers, this problem is not avoidable. I think the issue can be better addressed by developing and testing more fonts that are more friendly to those features. I have found, however, that certain fonts do work better in displaying the characters and the combining diacritics of the TPA. These fonts are, namely, the “ ﻿Brill﻿ ” font, the “ ﻿Code2000﻿ ” font, and the “ ﻿AndikaSix﻿ ” font developed by the SIL ( ﻿Summer Institute of Linguistics﻿ ). However, no font is perfect. There is also, of course, the notion of font development specific to the TPA, and font makers are known to develop fonts aimed at specific scripts. I have not developed any fonts, and I want to express my gratitude to those who did.

- [﻿](§15.5)**Unicode compliance:** The TPA is entirely based on the characters of Unicode. For computer compatibility, it cannot go outside of that scope. We don't have this problem if we write with a pen and paper. But our project is a Unicode phonetic alphabet, and computer typing is crucial. That is to say, there are no characters, diacritics, or punctuation marks that are outside of Unicode in the TPA.

- [﻿](§15.6)**Use of combining diacritics:** To solve the aforementioned problem of having one letter per sound, the TPA resorts to using combining diacritics that are added on top of or below the base letters. The official practice is to place all phonetic articulations, such as secondary articulations, on top of the letters while placing phonological markers below the letters. It is also allowed to place a second or a third diacritic below or above the letters if need be, and I know this may cause problems with fonts and displays on computers, but this gives us greater options.
...
[﻿](§15.27)This also helps avoid ambiguity as to where the stress marker should be placed, as it is almost always the vocoids that would receive this mark. It is also okay to use the stress diacritic for contoid letters if need be; although it seems like this is usually not necessary, it is valid otherwise.

[﻿](§15.28)Having two ways to write it gives us more options. You can do things like use the double letter notation under certain circumstances and the lengthening marker under other circumstances.

[﻿](§15.29)Compare TPA { ﻿aɕ̚ɕͪa﻿ } versus IPA [ ﻿at͡ʃʰːa﻿ ]. Ours is just so much more legible. I am proud of the fact that I have created a more legible phonetic alphabet.
...
[﻿](§15.33)Phonetic spelling transcription should be written below the orthographic spelling or next to words in phonetic spelling brackets. Example:

[﻿](§15.34)[ ﻿1:3﻿ ] Then God said, “ ﻿Let there be light.﻿ ”; and there was light.  
`{ ﻿ðen ɡad sæd, “ ﻿let ðeɻ bᵻ̄ layt﻿ ”; æn ðeɻ waz layt﻿ }`

[﻿](§15.35)Unlike the IPA, we just have three markers: short { ﻿◌﻿ }, long { ﻿◌ː﻿ } and extra‑long { ﻿◌ːː﻿ }.  
IPA has markers like extra‑short and some other ones, but I think they are just not necessary.

[﻿](§15.36)◌ː  modifier letter triangular colon (U+02D0)  
...
[﻿](§15.43)The preferred use is the middle dot character. For example: un·necessari·ly

[﻿](§15.44)◌◌·◌◌ middle dot (U+00B7)

##### [﻿](§15.45)*( ﻿5﻿ ) Writing diphthongs:* { ﻿◌◌﻿ }, { ﻿◌͡◌﻿ }, { ﻿◌͜◌﻿ }

[﻿](§15.46)Diphthongs are simply when two different vowels are pronounced in a single vowel segment. We start at the pronunciation of a vowel and glide towards the other one in a single segment. There is also the phenomenon of saying two different vowels separately, which is called a “ ﻿hiatus﻿ ” which is discussed here. To show that it is a diphthong and not a hiatus, they can be linked to each other using a tie bar. This way, there can be no ambiguity about whether we have diphthongs or separate vowels. They count as one vowel segment, along with triphthongs. Although triphthongs are rare, not all languages have diphthongs.

[﻿](§15.47)◌͡◌ combining double inverted breve (U+0361)  
◌͜◌ combining double breve below (U+035C)

##### [﻿](§15.48)*( ﻿6﻿ ) Writing triphthongs:* { ﻿◌◌◌﻿ }, { ﻿◌͡◌͡◌﻿ }, { ﻿◌͜◌͜◌﻿ }

[﻿](§15.49)Same practice as diphthongs, but another tie bar is used.  
This is because there isn't a triple combining tie bar in Unicode.

[﻿](§15.50)◌͡◌͡◌ combining double inverted breve ⨱ 2 (U+0361)  
◌͜◌͜◌ combining double breve below ⨱ 2 (U+035C)

##### [﻿](§15.51)*( ﻿7﻿ ) Writing rounded front vowels in the TPA:*

[﻿](§15.52)I didn't have enough appropriate‑looking characters for this set of vowels. So, I took the rear vowels and put slashes through them to make front‑rounded vowels out of the back‑rounded vowels.
...
[﻿](§15.54)Luckily, these are all precomposed letters, as I could just grab them from Unicode.
...
[﻿](§15.77)The double vertical line combining diacritic can be used to mark a whistled pronunciation. { ﻿◌̎﻿ }  
...
[﻿](§15.86)This diacritic is used to make an otherwise voiced letter voiceless. This can be used on letters such as the nasal letters or the vowels that do not have voiceless forms in the TPA, although technically, they can be voiceless.  
For example: { ﻿m̥, n̥, l̥, o̥, u̥, e̥﻿ }

[﻿](§15.87)◌̥ combining ring below (U+0325)

##### [﻿](§15.88)*( ﻿17﻿ ) Marking devoicing:* { ﻿◌͚﻿ }

[﻿](§15.89)This diacritic shows what was normally voiced in the base word has now become devoiced { ﻿d͚﻿ }. It uses the double ring below instead of the single ring below as is the case in making voiceless letters out of voiced letters.

[﻿](§15.90)◌͚ combining double ring below (U+035A)

##### [﻿](§15.91)*( ﻿18﻿ ) Marking vowel reduction:* { ﻿◌̣﻿ }

[﻿](§15.92)English example: proclamation `{pɻoklə̣ˈmeyşə̣n}`  
It's not very useful here with English because we are marking vowel reduction twice. This is because schwa is only used with reduced vowels in English.

[﻿](§15.93)Russian example: провозглаше́ние `{prạvạzɡlạˈşen̑ɪye}`

[﻿](§15.94)◌̣ combining dot below (U+0323)

##### [﻿](§15.95)*( ﻿19﻿ ) Marking vowel harmony:* { ﻿◌̤﻿ }

[﻿](§15.96)◌̤ combining diaeresis below (U+0324)

##### [﻿](§15.97)*( ﻿20﻿ ) Marking vowel harmony and vowel reduction:* { ﻿◌⃨﻿ }
...
[﻿](§15.101)https://en.wikipedia.org/wiki/No_audible_release
...
[﻿](§15.105)◌̉ combining hook above (U+0309)  
◌ˀ modifier letter glottal stop (U+02C0) (after the letter)  
...
##### [﻿](§15.118)*( ﻿26﻿ ) Marking pulmonic ingressive pronunciation:* { ﻿◌←﻿ }

[﻿](§15.119)This is backwards speech. They are not easy to pronounce, and I don't believe they are used in any languages, but they are included for completeness. Sometimes people do this when they gasp.

[﻿](§15.120)◌← leftwards arrow (U+2190)

##### [﻿](§15.121)*( ﻿27﻿ ) Marking nasal ingressive pronunciation:* { ﻿◌̃←﻿ }, { ﻿◌͠◌←﻿ }

[﻿](§15.122)This is typed with the ingressive marker as above and the nasalisation diacritic on top of it. For example, a “ ﻿snort﻿ ” is correctly written as { ﻿ꝶ̃←﻿ }. Some fonts may display this incorrectly.

[﻿](§15.123)◌̃← combining tilde (U+0303)＋leftwards arrow (U+2190)

##### [﻿](§15.124)*( ﻿28﻿ ) Marking pulmonic egressive pronunciation:* { ﻿◌→﻿ }

[﻿](§15.125)The pulmonic egressive marker is the right‑facing arrow { ﻿◌→﻿ }. This is possibly the most redundant and useless of the arrow markers because letters are by default pulmonic and egressive. So, you don't necessarily have to use this arrow as { ﻿s→﻿ } as it is the same thing as { ﻿s﻿ } anyway. This arrow cannot be used with anything that is not pulmonic egressive, as that just constitutes an error, such as with click letters, for example { ﻿ǂ→﻿ }.

[﻿](§15.126)◌→ rightwards arrow (U+2192)

##### [﻿](§15.127)*( ﻿29﻿ ) Marking tones:* { ﻿ꜛ◌, ꜜ◌﻿ }, { ﻿◌˥, ◌˦, ◌˧, ◌˨, ◌˩﻿ }

[﻿](§15.128){ ﻿ꜛ◌◌﻿ } upstep (before the letter or syllable)  
{ ﻿ꜜ◌◌﻿ } downstep (before the letter or syllable)

[﻿](§15.129){ ﻿◌᷇, ◌́, ◌᷆, ◌᷄, ◌̀, ◌᷅﻿ } combining diacritics for tone use

[﻿](§15.130){ ﻿◌˥, ◌˧, ◌˩﻿ } 3 level tonal system (simple)  
{ ﻿◌˥, ◌˦, ◌˧, ◌˨, ◌˩﻿ } 5 level tonal system (precise)

[﻿](§15.131){ ﻿◌˩˧, ◌˩˥, ◌˧˩, ◌˧˥, ◌˥˩, ◌˥˧﻿ } double contour tones (3 levels)  
{ ﻿◌˩˧˩, ◌˩˥˩, ◌˩˥˧, ◌˧˩˧, ◌˧˩˥, ◌˧˥˩, ◌˧˥˧, ◌˥˩˧, ◌˥˩˥, ◌˥˧˥﻿ } triple contour tones (3 levels)

[﻿](§15.132)We mark a lower shift in tone with { ꜜ◌ } and a higher shift in tone with { ﻿ꜛ◌﻿ }.  
“ ﻿ありがと﻿ ” — `{ ﻿aɾɪgaꜛᴛo﻿ }`  
“ ﻿ありがと﻿ ” — `{ ﻿aɾɪgaꜜᴛo﻿ }`
...
[﻿](§15.135)We can also use graphical markers that go to the right of the words or syllables.  
{ ﻿◌◌˥, ◌◌˧, ◌◌˩﻿ }, { ﻿◌◌˩˧, ◌◌˩˥, ◌◌˧˩, ◌◌˧˥, ◌◌˥˩, ◌◌˥˧﻿ }, { ﻿◌◌˩˧˩, ◌◌˩˥˩, ◌◌˩˥˧, ◌◌˧˩˧, ◌◌˧˩˥, ◌◌˧˥˩, ◌◌˧˥˧, ◌◌˥˩˧, ◌◌˥˩˥, ◌◌˥˧˥﻿ }  
Such as “ ﻿得﻿ ” — `{ ﻿dəo˧˥﻿ }`.

[﻿](§15.136)https://en.wikipedia.org/wiki/Tone_letter  
Although, typically, a five-level distinction is made with tones, I believe a three-level distinction can also suffice. In this scenario, we have high, mid, and low.

[﻿](§15.137)ꜛ modifier letter raised up arrow (U+A71B)  
ꜜ modifier letter raised down arrow (U+A71C)

[﻿](§15.138)◌᷇ combining acute-macron (U+1DC7)  
◌́ combining acute tone mark (U+0341)  
◌᷆ combining macron-grave (U+1DC6)  
◌᷄ combining macron-acute (U+1DC4)  
◌̀ combining grave tone mark (U+0340)  
◌᷅ combining grave-macron (U+1DC5)

[﻿](§15.139)˥ modifier letter extra-high tone bar (U+02E5)  
...
[﻿](§15.140)There are other tone bar characters in Unicode, but the ones listed here work the best.

[﻿](§15.141)It is also a good idea to place a hairspace between the word or the syllable segment followed by the tone bars. However, the space breaks the bar characters between line breaks. This can be prevented by using joining or no-break characters.  
More on this issue here:  
https://stackoverflow.com/questions/70989277/how-to-make-a-hair-space-and-thin-space-non-breaking

##### [﻿](§15.142)*( ﻿30﻿ ) Marking intonation:* { ﻿⭧﻿ ◌◌◌ ◌◌◌ ◌◌◌ ﻿⭧﻿ }, { ﻿⭨﻿ ◌◌◌ ◌◌◌ ◌◌◌ ﻿⭨﻿ }

[﻿](§15.143)https://en.wikipedia.org/wiki/Intonation_(linguistics)  
...
[﻿](§15.144)⭧◌◌◌⭧ north east triangle-headed arrow (U+2B67)  
⭨﻿ ◌◌◌⭨ south east triangle-headed arrow (U+2B68)

##### [﻿](§15.145)*( ﻿31﻿ ) Marking phonetic stress:* { ﻿◌̱﻿ }, { ﻿◌͟◌﻿ }, { ﻿◌◌ˌ◌◌◌ˈ◌◌ˌ◌◌◌﻿ }

[﻿](§15.146)https://en.wikipedia.org/wiki/Stress_(linguistics)  
In the IPA, phonetic stress is marked differently using an external symbol.  
But in the TPA, we just draw a line under the letter.

[﻿](§15.147)◌̱ combining macron below (U+0331)  
◌͟◌ combining double macron below (U+035F)

[﻿](§15.148)◌◌◌ˈ◌◌ modifier letter vertical line (U+02C8)  
◌◌ˌ◌◌◌ modifier letter low vertical line (U+02CC)

##### [﻿](§15.149)*( ﻿32﻿ ) Marking liaison:* { ﻿◌‿◌﻿ }

[﻿](§15.150)https://en.wikipedia.org/wiki/Liaison_(French)  
...
[﻿](§15.151)‿ undertie (U+203F)

##### [﻿](§15.152)*( ﻿33﻿ ) Marking optional pronunciation:* { ﻿◌◌(◌)◌, ◌◌(◌)﻿ }

[﻿](§15.153)This feature is basically where we mark a certain letter within a word in parentheses.  
For example, we can write the English word “ ﻿debt﻿ ” as { ﻿dept﻿ } or { ﻿de(p)t﻿ }.

##### [﻿](§15.154)*( ﻿34﻿ ) Marking syllabification:* { ﻿◌◌ˌ◌◌◌ˈ◌◌ˌ◌◌◌﻿ }

[﻿](§15.155)Same system as the IPA: /ˌɛkskləˈmeɪʃ(ə)n/

[﻿](§15.156)◌ˈ modifier letter vertical line (U+02C8)  
◌ˌ modifier letter low vertical line (U+02CC)

[﻿](§15.157)Be aware that these two characters break, same as the space character.

##### [﻿](§15.158)*( ﻿35﻿ ) Marking nasalisation:* { ﻿◌̃﻿ }, { ﻿◌͠◌﻿ }

[﻿](§15.159)These just mark that a vowel is being pronounced as a nasal vowel as opposed to an oral vowel. It is the same diacritic as the IPA. If we want to indicate a nasalised diphthong, we can use the double tilde instead.

[﻿](§15.160)◌̃ combining tilde (U+0303)  
◌͠◌ combining double tilde (U+0360)

##### [﻿](§15.161)*( ﻿36﻿ ) Marking denasalisation:* { ﻿◌͊﻿ }

[﻿](§15.162)I picked this diacritic because it looks just like the nasalisation diacritic but with a slash through it. This indicates to us that something that was normally nasalised is now denasalised and is oralised instead. I don't know if it is useful.

[﻿](§15.163)◌͊ combining not tilde above (U+034A)

##### [﻿](§15.164)*( ﻿37﻿ ) Marking paralinguistic functions:*

[﻿](§15.165){ ﻿ƾ﻿ } is for a cough.  
{ ﻿ꝶ̃←﻿ } is a snort.

[﻿](§15.166)ƾ latin letter inverted glottal stop with stroke (U+01BE)

[﻿](§15.167)When analysed phonetically, the cough is a “ ﻿glottal plosive﻿ ” and the snort is a “ ﻿nasal ingressive uvular trill﻿ ”.

##### [﻿](§15.168)*( ﻿38﻿ ) Marking stuttered pronunciation:* { ﻿p\p\p﻿ }

[﻿](§15.169)The stuttered pronunciation shows a repeat of the pronounced consonant.

[﻿](§15.170)\ reverse solidus (U+005C)

##### [﻿](§15.171)*( ﻿39﻿ ) Marking phone deletion:* { ﻿◌͓﻿ }

[﻿](§15.172)Simply write an ‘ ﻿x﻿ ’ under the letter that is not being pronounced anymore { ﻿◌͓﻿ }.

[﻿](§15.173)◌͓ combining x below (U+0353)

##### [﻿](§15.174)*( ﻿40﻿ ) Marking phonetic lenition:* { ﻿◌̝﻿ }

[﻿](§15.175)What this marker does is indicate that a phone is now being pronounced with less restriction in the vocal tract or that it has lenited. For example, Turkish “ ﻿*kayık*﻿ ” ( ﻿boat﻿ ) versus “ ﻿*kayığ̝ın*﻿ ” ( ﻿of the boat﻿ ). The ‘ ﻿k﻿ ’ lenites to ‘ ﻿ğ﻿ ’. That is, it went from a plosive pronunciation to an approximant pronunciation within the same place of articulation. This can also be useful in dealing with historical linguistics, as words often change over time.

[﻿](§15.176)◌̝ combining up tack below (U+031D)

##### [﻿](§15.177)*( ﻿41﻿ ) Marking phonetic fortition:* { ﻿◌̞﻿ }

[﻿](§15.178)This is just like lenition but the opposite phenomenon. A sound becomes more constricted or harder to pronounce instead.

[﻿](§15.179)◌̞ combining down tack below (U+031E)

##### [﻿](§15.180)*( ﻿42﻿ ) Marking phonetic lengthening:* { ﻿◌⃗﻿ }

[﻿](§15.181)What this does is show that a vowel that is normally pronounced short is now being pronounced long.  
It is supposed to be marked with the combining rightward arrow above (U+20D7), but the fonts just cannot render the character correctly.

[﻿](§15.182)◌⃗ combining right arrow above (U+20D7)

##### [﻿](§15.183)*( ﻿43﻿ ) Marking phonetic shortening:* { ﻿◌⃖﻿ }

[﻿](§15.184)Same thing as above, but instead, it shows that a long vowel or a long pronunciation is now short.  
It is supposed to be the combining left arrow above (U+20D6), but again, the fonts just do not display these characters properly.

[﻿](§15.185)◌⃖ combining left arrow above (U+20D6)
...
#### CHAPTER SIXTEEN ( ﻿ⅩⅥ﻿ ): Ordering of the Sounds of the TPA

[﻿](§16.1)In the Translingual Phonetic Alphabet, the first place of articulation is considered the glottis, and the last place of articulation is the nasal cavity. For example, this is the order as follows:

[﻿](§16.2)Glottal➜Epiglottal➜Pharyngeal➜Uvular➜Velar➜Palatal➜Alveolar➜Dental➜Interdental➜Labiodental➜Bilabial➜Nasal

[﻿](§16.3)Speech does not start at the lips; it starts at the glottis. This is because the air first has to pass through the glottis before it can pass through anywhere else. Thus, this is the correct ordering. I am not the only one ordering the sounds, starting from the last and most restricted position. The Devanagari alphabet also does the same thing and starts ordering from the most restricted and rear sounds, where often the first letter is considered ‘ ﻿क﻿ ’ — ‘ ﻿ka﻿ ’.

#### CHAPTER SEVENTEEN ( ﻿ⅩⅦ﻿ ): Using the Precise Phonetic Notation System

[﻿](§17.1)The TPA offers a way to transcribe words with more accuracy than would be typically needed. In this scenario, the person intentionally chooses not to omit anything in order to be more accurate, but it will make the transcription look more complicated.

[﻿](§17.2)For example, in this method, you would typically include the labial rounding diacritic for any contoid that is before a labially rounded vocoid, as this is in fact what the body naturally accounts for in a phenomenon known as “ ﻿phonetic assimilation﻿ ”.

[﻿](§17.3)Example: ⟨ ﻿Portugal﻿ ⟩ — { ﻿po̱ɻɕəgəl᷾﻿ } — {{ ﻿p̊o̱ɻ̊ɕəgəl᷾﻿ }}

[﻿](§17.4)Here, we accounted for the phonological phenomenon called reducing, as the { ﻿t﻿ } became a { ﻿ɕ﻿ }. We also accounted for the whole syllable receiving stress instead of only the vocoid by placing the stress marker below the contoid letter.

[﻿](§17.5)Of course, this takes away from the legibility, but the option to do very accurate transcriptions is there.
...
- [﻿](§18.3)ɨ, ᵼ̇ / ᵼ, ᵻ̇ / ᵻ — Same scenario as above but for the unrounded near-tense front vowel.
...
- [﻿](§18.8)ɟ / ɉ — Same scenario as above, but for the affricate letter. TPA uses the undotted letter and the IPA equivalent for this letter is [ ﻿ʝ﻿ ].

- [﻿](§18.9)ʝ — This is the letter for the voiced alveolo-palatal affricate in the IPA.  
  IPA uses this letter for the voiced palatal fricative, while TPA uses the letter ‘ ﻿ỿ﻿ ’.

- [﻿](§18.10)ꞵ / β — “latin small letter beta (U+03B2)” / “greek small letter beta”. In this scenario, the Latin letter is preferred. In fact, there are only three Greek letters in the TPA out of the total of one hundred and fifty letters.

#### CHAPTER NINETEEN ( ﻿ⅩⅨ﻿ ): Criticism of Phonetic Transcriptions with the IPA

[﻿](§19.1)The very first thing I want to criticise is the vowels of the IPA.

- [﻿](§19.2)The specific letter [ ﻿ɚ﻿ ] should not even be there in favour of [ ﻿əɻ﻿ ]. No other vowel letter has such a specific rhotic form, and this schwa letter should not either.

- [﻿](§19.3)I think that letters like [ ﻿ɒ, ä, ɐ, ɑ, ʌ﻿ ] should not be there. Only the letter { ﻿a﻿ } and its more open version { ﻿ᴀ﻿ } are valid. This leads people to use these letters falsely. For example, I saw someone spell out the Greek word “ ﻿*καρδιά*﻿ ” as [ ﻿kɐrðia﻿ ]. Why, when it would be simpler and more factual to spell it out as { ﻿karðia﻿ }? And is the first ‘ ﻿α﻿ ’ there different than the last one? It is even more shocking to see people insist on these letters when no language makes such a distinction between these ‘ ﻿a﻿ ’ letters. The TPA discards the use of these letters and instead uses { ﻿a, ᴀ﻿ } for open rear vowels.

- [﻿](§19.4)The IPA is also calling ‘ ﻿æ﻿ ’ a front vowel even though it is clearly a central open vowel and a merging of the letters ‘ ﻿a﻿ ’ and ‘ ﻿e﻿ ’. It is classifying ‘ ﻿a﻿ ’ incorrectly as a front vowel when it is a back vowel. I am shocked to see how they can be so wrong when it comes to the vowels.

#### CHAPTER TWENTY ( ﻿ⅩⅩ﻿ ): Closing

[﻿](§20.1)In this closing chapter, I want to talk freely and give commentary on this work.
