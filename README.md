...
The TPA has 28 simple vocoids (vowels) + 4 semi-vowels (approximants).
This number is set and will not be changing in the future versions.

The vowels are based on the metrics of the human mouth, the tongue, the jaw and the rounding of the lips.
...
====================================================================================================
The TPA "officially" orders the phones starting from the throat as it considers the starting point of speech
and the first place of articulation in the vocal tract to be the glottis (throat), and the last place of articulation 
to be the nasal cavity (after the lips at the exterior of the oral cavity).
...
towards the throat.
(This isn't an official ordering of the places of articulations in the IPA, but in charts you often see the lips listed first)

In the TPA, there are about 22 places of articulations and this is subject to change.
The tongue also has its own 4 places of articulations named "Dorsal", "Laminal", "Apical" and "Apical-Subapical".

Sometimes, it is possible to place a different part of the tongue on the same place of articulation.
For example, at the alveolar ridge, which is the frontal ridge of the human palate;
Either the tip of the tongue or the "blade" of the tongue (the area behind the tip of the tongue) may be
placed at the lower side of the alveolar ridge or the upper side of the alveolar ridge.

Thus, this place of articulation is a hotbed of possible sounds to be articulated and is the place of articulation
with the highest number of possible combinations of articulations.

====================================================================================================
THE MANNERS OF ARTICULATIONS:
====================================================================================================
The "Manner of Articulations" are ordered starting from the most restrictive towards the least restrictive phones.
(It is also like that in the IPA, although there is still a difference in the ordering between the TPA and the IPA.)

In the TPA, there are about 14 manners of articulations, they are mainly differentiated by their pathway (oral or nasal), occlusivity(occlusive, strictive, non-strictive), manner (plosive, fricative, nasal etc) and this is subject to change.
...
there can be any other manner of a sound production.

2 of the manners can be either egressive (outwards) or ingressive (inwards), that gives us 4 and 3 that are mono directional.
Which makes 7.
...
Suctional Ingressives (Clicks)

Percussives (articulators only move towards one another)
...
is NECESSARY in order to pronounce glottalics. These still rely on air, however not on inhalation or exhalation but instead on a
...
The suctionals are sounds that have nothing to do with both the glottis (the throat) as well as the lungs and the inhalation
and the exhalation of air. This is in contrast to the pulmonics and glottalics.

These sounds are articulated solely using suction with the articulatory organs (such as the lips in the kissing sound )

The lingual egressive manner of production also has nothing to do with the throat or the glottis.
In this case, the sounds are articulated by pushing the air out with the tongue.
This also kills the possibility of having a place of articulation that is behind the tongue for the lingual egressives.
...
I concluded that the Upper Alveolar part of the mouth is the starting point for the lingual egressives (velarics) and anything
further back than that is not possible to be articulated.
...
However, they can be "held" at place, even though they can't be "continued"

Another example, glottalic ingressives (implosives) can only be occlusives, they can not be strictivs or non-strictives.
...
Non-Continuant phones can not be long in duration due to their nature. Although, some of them can be "held" in place.
Making them "look" as if they are long in duration.
====================================================================================================
PHONATION:
====================================================================================================
...
====================================================================================================
	The different combinations of the places of articulations, manners of articulations, the manners of productions
give us a complete picture of how the phonetic system operates.

This system is based on boolean logic, and I try to ensure its concepts and explanations do not violate boolean logic.

====================================================================================================
INCLUSION OF LETTERS:
====================================================================================================
	Proof of pronunciation is necessary for the inclusion of a phone into the TPA and currently there are over 300 different
...
For example, the IPA letter [i] has been changed to {ɩ} in the TPA. Even though, computationally there isn't a combining
...
AFFRICATE SYSTEM:
====================================================================================================
	The "affricates" also differ from the IPA to some extent in order to be more accurate and legible.
...
Affricates (Stop-Strictives) are stops (plosives that are held in place) that are immediately followed by strictives.
...
There is even a specific letter for it called "psi" (Ψ).
This is not an affricate as they do not share a place of articulation. This is a contoid cluster.
(2 seperate contoids without a vowel in between.)

- They cannot have seperate phonations.
For example, a voiced stop followed by a voiceless fricative is not an affricate.
That too, would be a contoid cluster
...
==============================================
 CONCLUSION:
 ==============================================
	The TPA is not designed with a specific language in mind.
In fact, it has nothing to do with any language but instead, it is designed based on the mechanisms of the human vocal tract.

The TPA is not designed for use in speech therapy. 
Although it may be used as such.
